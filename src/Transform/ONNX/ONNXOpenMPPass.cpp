...
struct ONNXOpenMPPass
    : public PassWrapper<ONNXOpenMPPass, OperationPass<func::FuncOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ONNXOpenMPPass)

  StringRef getArgument() const override { return "onnx-openmp-transform"; }
