export MLIR_DIR=$/Users/lixizhou/GitHub/ONNX-MLIR-Native/llvm-project/build/lib/cmake/mlir
export LLVM_BIN_DIR=/Users/lixizhou/GitHub/ONNX-MLIR-Native/llvm-project/build/bin
...
export ONNX_MLIR_RUNTIME_DIR=$(pwd)/build/Debug/lib