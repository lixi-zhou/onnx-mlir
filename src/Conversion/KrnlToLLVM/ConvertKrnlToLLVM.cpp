...
struct ConvertKrnlToLLVMPass
  ...
  ConvertKrnlToLLVMPass(bool verifyInputTensors, bool useOpaquePointers,
      ...
      uint64_t constantsToFileTotalThreshold, std::string outputNameNoExt, bool enableParallel) {
...
void ConvertKrnlToLLVMPass::runOnOperation() {
  ...
  target.addLegalOp<mlir::omp::TerminatorOp, mlir::omp::TaskyieldOp, mlir::omp::FlushOp,
                        mlir::omp::YieldOp, mlir::omp::BarrierOp, mlir::omp::TaskwaitOp>();
